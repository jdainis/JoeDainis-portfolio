...
#Data Cleaning
##Change column names
colnames(vaccdata) <- c("FIPS_code", "county_name", "state", "estimated_hesitancy", "estimated_unsure", "estimated_strongly_hesitant", "SVI", "SVI_category", "CVAC", "CVAC_category", "percent_vaccinated_adults", "percent_Hispanic", "percent_AmericanIndianorNative", "percent_Asian", "percent_Black", "percent_NativeHawaiian", "percent_white", "geographical_point", "state_code", "county_boundary", "state_boundary")
